...
const Question: FC<QuestionAnswerProps> = ({text}) => {
    return <article className={questionSectionStyles.question}>
        <h2>{text}</h2>
    </article>
}
const Answer: FC<QuestionAnswerProps> = ({text}) => {
    return <article className={questionSectionStyles.answer}>
        <h2>{text}</h2>
    </article>
}
...
const QuestionSection: FC<QuestionSectionProps> = ({question, answer}) => {
    return <section className={questionSectionStyles.questionSection}>
